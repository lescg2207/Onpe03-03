...
<body>
	...
	<div id="imprimelo3">
		<div class="container">
			<img src="images/f-participacion.jpg" width="auto" height="248"
			...
			<section class="menu navbar-default menu05">
				...
				<nav class="navbar-collapse bs-navbar-collapse collapse"
					...
					<ul class="nav navbar-nav">
						...
						<li class="bt-amarillo"><a href="actas.jsp">ACTAS</a></li>
						...
						<div class="contenido-interna">
							...
							<table>
								<tr>
									...
									<td width="60%">&nbsp;</td>
									<td><button type="button" class="btn btn-primary"
											onclick="#">REPORTE DETALLADO EN EXCEL</button></td>
								</tr>
							</table>
							<%
							}
								...
								<div id="page-wrap">
									<table class="table21">
										<tbody>
											...
											%>
											<tr
												onclick="location.href='svlParticipacion?id=<%=(id + "," + aData[0])%>'"
